...
PKG = "taiyo" # Edit with your package name
...
setup(
		...
		description                   = "a package dedicated for fetching and processing data from National Solar Radiation Database (NSRDB)",
		...
		install_requires = ["numpy", "pandas"] # Add/Edit as Required
	)